 ...
 * @generated
 */
public class ServiceblueprintModelingAssistantProviderOfOnStageEmployeeActionEditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((OnStageEmployeeActionEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			OnStageEmployeeActionEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(OnStageEmployeeActionEditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		return doGetTypesForTarget(
				(OnStageEmployeeActionEditPart) sourceEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForTarget(
			OnStageEmployeeActionEditPart source, IElementType relationshipType) {
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((OnStageEmployeeActionEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			OnStageEmployeeActionEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(ServiceblueprintElementTypes.ServiceBlueprintConnection_4001);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(OnStageEmployeeActionEditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			OnStageEmployeeActionEditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ServiceblueprintElementTypes.ServiceBlueprintConnection_4001) {
			types.add(ServiceblueprintElementTypes.PhysicalEvidence_3001);
			types.add(ServiceblueprintElementTypes.CustomerAction_3002);
