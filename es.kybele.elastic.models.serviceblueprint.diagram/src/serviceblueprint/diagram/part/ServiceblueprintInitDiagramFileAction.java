 ...
 * @generated
 */
public class ServiceblueprintInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ServiceblueprintNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ServiceBlueprintModelEditPart.MODEL_ID));
		ServiceblueprintDiagramEditorUtil.runWizard(getShell(), wizard,
